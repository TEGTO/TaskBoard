...
import { MockActivityService, MockTaskListService, MockTaskService, mockTask, mockTaskMuchText } from "../mockServices";
...
const meta: Meta<TaskManagerComponent> = {
    ...
    decorators: [
        moduleMetadata({
            ...
            providers: [
                FormBuilder,
                { provide: MatDialogRef<TaskManagerComponent>, useValue: {} },
